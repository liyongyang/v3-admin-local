...
$border-radius: map.merge(('base': 4px,
    'small': 2px,
    'round': 20px,
    'circle': 100%,
  ),
...
// Box-shadow
$box-shadow: () !default;
$box-shadow: map.merge(('': (0px 12px 32px 4px rgba(0, 0, 0, 0.04),
...
// Typography
$font-family: () !default;
$font-family: map.merge(( // default family
    '': "'Helvetica Neue', Helvetica, 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', '微软雅黑', Arial, sans-serif"
  ),
  $font-family);

$font-size: () !default;
$font-size: map.merge(('extra-large': 20px,
    'large': 18px,
    'medium': 16px,
    'base': 14px,
    'small': 13px,
...
// Disable default
$disabled: () !default;
$disabled: map.merge(('bg-color': getCssVar('fill-color', 'light'),
...
$common-component-size: map.merge(('large': 40px,
    'default': 32px,
    'small': 24px,
  ),
...
$overlay-color: map.merge(('': rgba(0, 0, 0, 0.8),
...
// mask
$mask-color: () !default;
$mask-color: map.merge(('': rgba(255, 255, 255, 0.9),
...
$checkbox-button: map.merge(('checked-bg-color': getCssVar('color-primary'),
...
$checkbox-bordered-padding-left: map.merge(('large': 12px,
    'default': 10px,
    'small': 8px,
  ),
...
$checkbox-bordered-padding-right: map.merge(('large': 20px,
    'default': 16px,
    'small': 12px,
  ),
...
/// fontSize||Font|1
$radio: () !default;
$radio: map.merge(('font-size': getCssVar('font-size-base'),
    'text-color': getCssVar('text-color-regular'),
    'font-weight': getCssVar('font-weight-primary'),
    'input-height': 14px,
    'input-width': 14px,
...
$radio-button: map.merge(('checked-bg-color': getCssVar('color-primary'),
    'checked-text-color': getCssVar('color-white'),
    'checked-border-color': getCssVar('color-primary'),
...
$radio-disabled: map.merge(('input-border-color': getCssVar('disabled-border-color'),
...
$radio-checked: map.merge(('text-color': getCssVar('color-primary'),
...
$radio-bordered-input-height: map.merge(('large': 14px,
    'default': 12px,
    'small': 12px,
  ),
...
$radio-bordered-input-width: map.merge(('large': 14px,
    'default': 12px,
    'small': 12px,
  ),
...
// Select
$select: () !default;
$select: map.merge(('border-color-hover': getCssVar('border-color-hover'),
...
$select-option: map.merge(('text-color': getCssVar('text-color-regular'),
...
$select-group: map.merge(('text-color': getCssVar('color-info'),
    'height': 30px,
    'font-size': 12px,
  ),
  $select-group);
...
$select-dropdown: map.merge(('bg-color': getCssVar('bg-color', 'overlay'),
...
$select-tags-prefix-padding: map.merge(('large': 8px,
    'default': 6px,
    'small': 4px,
  ),
...
$alert: () !default;
$alert: map.merge(('padding': 8px 16px,
...
$message: () !default;
$message: map.merge(('bg-color': getCssVar('color', 'info', 'light-9'),
...
$notification: map.merge(('width': 330px,
    'padding': 14px 26px 14px 13px,
    'radius': 8px,
    'shadow': getCssVar('box-shadow-light'),
    'border-color': getCssVar('border-color-lighter'),
    'icon-size': 24px,
    'close-font-size': var(#{getCssVarName('message-close-size')},
...
$input: () !default;
$input: map.merge(('text-color': getCssVar('text-color-regular'),
...
$input-disabled: map.merge(('fill': getCssVar('disabled-bg-color'),
...
$input-font-size: map.merge(('large': 14px,
    'default': 14px,
    'small': 12px,
  ),
  $input-font-size);
...
$input-number-width: map.merge(('large': 180px,
    'default': 150px,
    'small': 120px,
  ),
  $input-number-width);
...
$input-padding-horizontal: map.merge(('large': 16px,
    'default': 12px,
    'small': 8px,
  ),
...
$cascader: () !default;
$cascader: map.merge(('menu-text-color': getCssVar('text-color-regular'),
...
$statistic: () !default;
$statistic: map.merge(('title-font-weight': 400,
...
$button: () !default;
$button: map.merge(('font-weight': getCssVar('font-weight-primary'),
    'border-color': getCssVar('border-color'),
    'bg-color': getCssVar('fill-color', 'blank'),
    'text-color': getCssVar('text-color', 'regular'),
...
@each $type in $types {
  $button-border-color: map.merge(($type: map.get($colors, $type, 'base'),
      ),
      $button-border-color) !global;

  $button-bg-color: map.merge(($type: map.get($colors, $type, 'base'),
      ),
      $button-bg-color) !global;
}

$button-font-size: () !default;
$button-font-size: map.merge(('large': getCssVar('font-size', 'base'),
...
$button-border-radius: map.merge(('large': getCssVar('border-radius', 'base'),
...
$button-padding-vertical: map.merge(('large': 13px,
    'default': 9px,
    'small': 6px,
  ),
...
$button-padding-horizontal: map.merge(('large': 20px,
    'default': 16px,
    'small': 12px,
  ),
...
$switch: () !default;
$switch: map.merge(('on-color': getCssVar('color-primary'),
...
$table: () !default;
$table: map.merge(('border-color': getCssVar('border-color-lighter'),
...
$table-font-size: map.merge(('large': getCssVar('font-size', 'base'),
    'default': 14px,
    'small': 12px,
  ),
  $table-font-size);
...
$table-padding: map.merge(('large': 12px 0,
    'default': 8px 0,
    'small': 4px 0,
  ),
  $table-padding);
...
$table-cell-padding: map.merge(('large': 0 16px,
    'default': 0 12px,
    'small': 0 8px,
  ),
  $table-cell-padding);
...
$pagination: () !default;
$pagination: map.merge(('font-size': 14px,
    'bg-color': getCssVar('fill-color', 'blank'),
...
$popup: () !default;
$popup: map.merge(('modal-bg-color': getCssVar('color-black'),
    'modal-opacity': 0.5,
  ),
  $popup);
...
$popper: () !default;
$popper: map.merge(('border-radius': var(#{getCssVarName('popover-border-radius')}, 4px),
  ),
  $popper);

// skeleton
$skeleton: () !default;
$skeleton: map.merge(('color': getCssVar('fill-color'),
...
$tag-height: () !default;
$tag-height: map.merge(('large': 32px,
    'default': 24px,
    'small': 20px,
  ),
  $tag-height);
...
$tag-padding: () !default;
$tag-padding: map.merge(('large': 12px,
    'default': 10px,
    'small': 8px,
  ),
  $tag-padding);
...
$tag-icon-size: map.merge(('large': 16px,
    'default': 14px,
    'small': 12px,
  ),
  $tag-icon-size);
...
$text: () !default;
$text: map.merge(('font-size': getCssVar('font-size', 'base'),
    'color': getCssVar('text-color', 'regular'),
  ),
  $text);

$text-font-size: () !default;
$text-font-size: map.merge(('large': getCssVar('font-size', 'medium'),
    'default': getCssVar('font-size', 'base'),
...
$tree: () !default;
$tree: map.merge(('node-hover-bg-color': getCssVar('fill-color', 'light'),
    'text-color': getCssVar('text-color-regular'),
...
// drawer
$drawer: () !default;
$drawer: map.merge(('bg-color': var(#{getCssVarName('dialog', 'bg-color')}, #{getCssVar('bg-color')}),
...
$badge: () !default;
$badge: map.merge(('bg-color': getCssVar('color-danger'),
    'radius': 10px,
    'font-size': 12px,
    'padding': 6px,
    'size': 18px,
...
// Card
$card: () !default;
$card: map.merge(('border-color': getCssVar('border-color', 'light'),
    'border-radius': 4px,
    'padding': 20px,
    'bg-color': getCssVar('fill-color', 'blank'),
  ),
...
$slider: () !default;
$slider: map.merge(('main-bg-color': getCssVar('color-primary'),
...
$datepicker: () !default;
$datepicker: map.merge(('text-color': getCssVar('text-color-regular'),
...
$date-editor: () !default;
$date-editor: map.merge(('width': 220px,
...
$loading: () !default;
$loading: map.merge(('spinner-size': 42px,
...
$scrollbar: () !default;
$scrollbar: map.merge(('opacity': 0.3,
...
$carousel: () !default;
$carousel: map.merge(('arrow-font-size': 12px,
    'arrow-size': 36px,
...
$collapse: () !default;
$collapse: map.merge(('border-color': getCssVar('border-color-lighter'),
    'header-height': 48px,
...
$transfer: () !default;
$transfer: map.merge(('border-color': getCssVar('border-color-lighter'),
    'border-radius': getCssVar('border-radius-base'),
    'panel-width': 200px,
...
$timeline: () !default;
$timeline: map.merge(('node-size-normal': 12px,
...
$tabs: () !default;
$tabs: map.merge(('header-height': 40px,
  ),
  $tabs);
...
$backtop: () !default;
$backtop: map.merge(('bg-color': getCssVar('bg-color', 'overlay'),
...
$link: () !default;
$link: map.merge(('font-size': getCssVar('font-size-base'),
    'font-weight': getCssVar('font-weight-primary'),
    'text-color': getCssVar('text-color-regular'),
    'hover-text-color': getCssVar('color-primary'),
...
@each $type in $types {
  $link-text-color: map.merge($link-text-color,
...
$calendar: () !default;
$calendar: map.merge(('border': var(#{getCssVarName('table-border')},
...
$form: () !default;
$form: map.merge(('label-font-size': getCssVar('font-size-base'),
  ),
  $form);
...
$avatar: () !default;
$avatar: map.merge(('text-color': getCssVar('color-white'),
...
$avatar-size: () !default;
$avatar-size: map.merge(('large': 56px,
    'default': 40px,
    'small': 24px,
  ),
  $avatar-size);
...
$empty: () !default;
$empty: map.merge(('padding': 40px 0,
    'image-width': 160px,
...
$descriptions: map.merge(('table-border': 1px solid getCssVar('border-color-lighter'),
...
$result: () !default;
$result: map.merge(('padding': 40px 30px,
    'icon-font-size': 64px,
...
$upload: () !default;
$upload: map.merge(('dragger-padding-horizontal': 40px,
...
// transition
$transition: () !default;
$transition: map.merge(('all': all getCssVar('transition-duration') getCssVar('transition-function-ease-in-out-bezier'),
    'fade': opacity getCssVar('transition-duration') getCssVar('transition-function-fast-bezier'),
    'md-fade': (transform getCssVar('transition-duration') getCssVar('transition-function-fast-bezier'),
...
$transition-duration: map.merge(('': 0.3s,
    'fast': 0.2s,
  ),
  $transition-duration);

$transition-function: () !default;
$transition-function: map.merge(('ease-in-out-bezier': cubic-bezier(0.645, 0.045, 0.355, 1),
...
// header
$header: () !default;
$header: map.merge(('padding': 0 20px,
    'height': 60px,
  ),
  $header);
// main
$main: () !default;
$main: map.merge(('padding': 20px,
  ),
  $main);
// footer
$footer: () !default;
$footer: map.merge(('padding': 0 20px,
    'height': 60px,
  ),
  $footer);
